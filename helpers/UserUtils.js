...
module.exports = function() {
    return {
        signupValidation: (req, res, next) => {
            ...
            req.checkBody("username", "Username length should not be less than 5").isLength({min: 5});
            ...
            req.checkBody("password", "Password length should not be less than 8").isLength({min: 8});
